/*
 * linux/drivers/video/fbdev/exynos/panel/s6e8fc3/s6e8fc3_a15x_aod_panel.h
 *
...
#ifndef __S6E8FC3_A15X_AOD_PANEL_H__
#define __S6E8FC3_A15X_AOD_PANEL_H__

#include "oled_common_aod.h"
#include "s6e8fc3_a15x_self_mask_img.h"
#include "s6e8fc3_aod.h"

#define S6E8FC3_A15XSELF_MASK_VALID_CRC_1 (0x49)
#define S6E8FC3_A15XSELF_MASK_VALID_CRC_2 (0xF4)

static u8 s6e8fc3_a15x_self_mask_crc[] = {
	S6E8FC3_A15XSELF_MASK_VALID_CRC_1,
	S6E8FC3_A15XSELF_MASK_VALID_CRC_2,
};
...
static DEFINE_RULE_BASED_COND(a15x_cond_is_factory_selfmask,
		PANEL_PROPERTY_IS_FACTORY_MODE, EQ, 1);

static void *s6e8fc3_a15x_aod_self_mask_ena_cmdtbl[] = {
	&KEYINFO(s6e8fc3_aod_l2_key_enable),
	&CONDINFO_IF(a15x_cond_is_factory_selfmask),
		&PKTINFO(s6e8fc3_aod_factory_self_mask_ctrl_ena),
	&CONDINFO_EL(a15x_cond_is_factory_selfmask),
		&PKTINFO(s6e8fc3_aod_self_mask_ctrl_ena),
	&CONDINFO_FI(a15x_cond_is_factory_selfmask),
...
static void *s6e8fc3_a15x_aod_self_mask_dis_cmdtbl[] = {
	&KEYINFO(s6e8fc3_aod_l2_key_enable),
...
// --------------------- check sum control ----------------------------
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e8fc3_a15x_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, S6E8FC3_A15X_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);

#if defined(__PANEL_NOT_USED_VARIABLE__)
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e8fc3_a15x_aod_self_mask_crc_img_pkt,
		DSI_PKT_TYPE_WR_SR, S6E8FC3_A15X_SELF_MASK_CRC_IMG, 0, PKT_OPTION_SR_ALIGN_16);
#endif
...
static void *s6e8fc3_a15x_aod_self_mask_crc_cmdtbl[] = {
	...
	&PKTINFO(s6e8fc3_a15x_aod_self_mask_img_pkt), /* Using Normal img */
	&DLYINFO(s6e8fc3_aod_self_1ms_delay),
...
static void *s6e8fc3_a15x_aod_self_mask_img_cmdtbl[] = {
	&KEYINFO(s6e8fc3_aod_l2_key_enable),
	&PKTINFO(s6e8fc3_aod_self_mask_sd_path_1),
	&PKTINFO(s6e8fc3_aod_self_mask_sd_path_2),

	&DLYINFO(s6e8fc3_aod_self_spsram_sel_delay),
	&PKTINFO(s6e8fc3_a15x_aod_self_mask_img_pkt),
...
static struct seqinfo s6e8fc3_a15x_aod_seqtbl[] = {
	SEQINFO_INIT(SELF_MASK_IMG_SEQ, s6e8fc3_a15x_aod_self_mask_img_cmdtbl),
	SEQINFO_INIT(SELF_MASK_ENA_SEQ, s6e8fc3_a15x_aod_self_mask_ena_cmdtbl),
	SEQINFO_INIT(SELF_MASK_DIS_SEQ, s6e8fc3_a15x_aod_self_mask_dis_cmdtbl),
	SEQINFO_INIT(SELF_MASK_CRC_SEQ, s6e8fc3_a15x_aod_self_mask_crc_cmdtbl),
};

static struct aod_tune s6e8fc3_a15x_aod = {
	.name = "s6e8fc3_a15x_aod",
	.nr_seqtbl = ARRAY_SIZE(s6e8fc3_a15x_aod_seqtbl),
	.seqtbl = s6e8fc3_a15x_aod_seqtbl,
	.nr_maptbl = ARRAY_SIZE(s6e8fc3_aod_maptbl),
	.maptbl = s6e8fc3_aod_maptbl,
	.self_mask_en = true,
	.self_mask_crc = s6e8fc3_a15x_self_mask_crc,
	.self_mask_crc_len = ARRAY_SIZE(s6e8fc3_a15x_self_mask_crc),
};
#endif
